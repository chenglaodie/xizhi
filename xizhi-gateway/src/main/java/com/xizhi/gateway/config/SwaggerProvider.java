package com.xizhi.gateway.config;
 ...
 * @PackageName com.xizhi.gateway.config
 * @Description 
 * @Author daiz
...
public class SwaggerProvider implements SwaggerResourcesProvider
{
    ...
    public List<SwaggerResource> get()
    {
        ...
        gatewayProperties.getRoutes().stream().filter(routeDefinition -> routeDefinition.getId().equals("xizhi-system"))
