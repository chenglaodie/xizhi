package com.xizhi.common.redis.aspect;

import java.lang.reflect.Method;

import com.xizhi.common.redis.annotation.RedisCache;
import com.xizhi.common.redis.annotation.RedisEvict;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.xizhi.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.xizhi.common.redis.annotation.RedisEvict)")
